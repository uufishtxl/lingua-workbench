...
export const usePomodoroStore = defineStore('pomodoro', () => {
    ...
    function playAudioTone(frequency = 440, type: OscillatorType = 'sine', duration = 0.5) {
        ...
        // Also vibrate if possible (mobile feedback)
    ...
    async function startTimer() {
        ...
        // Ensure audio is ready on user gesture
        initAudio();
        ...
        // Apply Wake Lock when starting Work or Rest
        requestWakeLock();
    ...
    function handleTimerComplete() {
        ...
        if (currentState.value === 'WORK') {
            playAudioTone(880, 'sine', 1.0); // End of work chime
